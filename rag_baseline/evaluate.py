...
def run_evaluation(cfg: RAGConfig, queries_path: str, output_path: str = None):
    ...
    if output_path:
        out = { "avg_faithfulness": float(result_df["faithfulness"].mean()),
                "details": results,
